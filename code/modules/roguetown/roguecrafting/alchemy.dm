...
/datum/crafting_recipe/roguetown/alchemy/ozium
	...
	reqs = list(/obj/item/ash = 2, /datum/reagent/toxin/berrypoison = 2, /obj/item/reagent_containers/food/snacks/grown/rogue/swampweeddry = 1)
	craftdiff = 2
...
/datum/crafting_recipe/roguetown/alchemy/ozium_3x
	...
	result = list(/obj/item/reagent_containers/powder/ozium,
					...
					/obj/item/reagent_containers/powder/ozium)
	reqs = list(/obj/item/ash = 3, /datum/reagent/toxin/berrypoison = 3, /obj/item/reagent_containers/food/snacks/grown/rogue/swampweeddry = 2)
	craftdiff = 3
